        ...
        {item.subItems.map((subItem) => {
          ...
          return (
            ...
            >
              ...
              <span className="flex-1 text-left font-medium overflow-hidden text-ellipsis whitespace-nowrap">{subItem.label}</span>
            </Link>
          );
        })}
      </div>,
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                ...
                >
                  ...
                  {!collapsed && (
                    <span className="text-sm font-semibold relative z-10 flex-1 text-left overflow-hidden text-ellipsis whitespace-nowrap">{primaryMenuLabel}</span>
                  )}
                </button>
              </TooltipTrigger>
              {collapsed && (
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          ...
                          >
                            ...
                            {!collapsed && (
                              <>
                                <span className="flex-1 text-left overflow-hidden text-ellipsis whitespace-nowrap">{item.label}</span>
                          ...
                          {item.subItems.map((subItem, subIndex) => {
                            ...
                            if (!hasNested) {
                              return (
                                ...
                                >
                                  ...
                                  <span className="font-medium flex-1 overflow-hidden text-ellipsis whitespace-nowrap">{subItem.label}</span>
                                </Link>
                              );
                            }
                            ...
                            return (
                              <div key={`${subItem.label}-${subIndex}`} className="space-y-0.5">
                                ...
                                >
                                  <SubIcon size={14} className="mr-2 shrink-0" />
                                  <span className="font-medium flex-1 text-left overflow-hidden text-ellipsis whitespace-nowrap">{subItem.label}</span>
                                    ...
                                    {subItem.subItems!.map((nestedItem, nestedIndex) => {
                                      ...
                                      return (
                                        ...
                                        >
                                          ...
                                          <span className="font-medium flex-1 overflow-hidden text-ellipsis whitespace-nowrap">{nestedItem.label}</span>
                                        </Link>
                                      );
                                    })}
                                  </div>
